    ...
    public class BlogCommentRepository : IBlogCommentRepository
    {
        ...
        public async Task<int> DeleteAsync(int blogCommentId)
        {
            ...
            )
            {
                ...
                affectedRows =
                    await connection
                        .ExecuteAsync("BlogComment_Delete",
        ...
        public async Task<List<BlogComment>> GetAllAsync(int blogId)
        {
            ...
            )
            {
                ...
                blogComments =
                    await connection
                        .QueryAsync<BlogComment>("BlogComment_GetAll",
                        new { BlogId = blogId },
                        commandType: CommandType.StoredProcedure);
            }
        ...
        public async Task<BlogComment>
        UpsertAsync(BlogCommentCreate blogCreate, string applicationUserId)
        {
            ...
            )
            {
                ...
                newBlogCommentId =
                    await connection
                        .ExecuteScalarAsync<int?>("BlogComment_Upsert",
                        new {
                            BlogComment =
                                dataTable
                                    .AsTableValuedParameter("dbo.BlogCommentType"),
                            ApplicationUserId = applicationUserId
                        },
                        commandType: CommandType.StoredProcedure);
            }
            newBlogCommentId = newBlogCommentId ?? blogCreate.BlogId;
